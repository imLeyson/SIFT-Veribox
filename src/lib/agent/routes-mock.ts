    ...
    const routes: Route[] = [
      {
        ...
        pros: "在琳琅满目的货架中形成大留白视觉真空，客户拿在手中触感厚重温润，耐看不过时",
        cons: "正面无多余装饰遮丑，极度考验中西文字距与压凹机台精度；特种纸无覆膜需注意仓储防蹭脏",
        feasibility: "high",
        timeframe: "0.5–1 天",
        ...
        steps: [
          {
            id: "step_tea_mat_1",
            title: "白模比例与纸样筛选",
            question: "茶汤的原生透光色调与何种原浆触感纸搭配最显清冽？",
            purpose: "确立第一眼的触觉基准与白度微调",
            deliverables: ["3 组 300g+ 特种原浆纸样卡", "1:1 罐身实物白模打样"],
            acceptanceCriteria: ["纸张克重不低于 280g 保证挺度", "自然光下无刺眼塑料反光，触感温和"],
          },
          {
            id: "step_tea_mat_2",
            title: "中西文字阶与封签动线",
            question: "开盒封签到正面主品名的视线如何自然过渡？",
            purpose: "构建开箱第一眼的视觉仪式感与信息骨架",
          ...
          },
          {
            ...
            deliverables: ["0.5mm 深压凹打样样张", "1.5米货架盲测对比图"],
            acceptanceCriteria: ["45度侧光下压凹轮廓清晰无毛边", "背面无明显穿透凸痕与纸张爆裂"],
          },
        ],
      },
      {
        ...
        steps: [
          ...
          },
          {
            ...
            purpose: "验证网格排版在真实陈列中的穿透力",
            deliverables: ["货架陈列黑白视线对照图", "高斯模糊视距测试稿"],
      ...
      },
      {
        ...
        steps: [
          ...
          },
          {
            ...
            purpose: "打磨全方位无死角的桌面立体视觉",
            deliverables: ["罐体全圆周展开平面图", "360度多角度旋转效果图"],
            acceptanceCriteria: ["转动任意角度均具备独立构图美感", "生产批号与条码妥善收拢于背面"],
          },
        ],
      },
    ];
